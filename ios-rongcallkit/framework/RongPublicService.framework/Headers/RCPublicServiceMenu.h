...
/*!
 ...
 - Note: 公众服务菜单类，其中包含若干数量的菜单项，每个菜单项可能还包含子菜单项。
 公众服务菜单的树状结构如下所示：
 Menu -> MenuItem1
...
/*!
 ...
 - Parameter jsonDictionary:公众服务菜单项Json组成的数组

 - Warning: **已废弃，请勿使用。**
 */
- (void)decodeWithJsonDictionaryArray:(NSArray *)jsonDictionary __attribute__((deprecated));
